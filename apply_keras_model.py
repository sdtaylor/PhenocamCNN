...
keras_model = keras.models.load_model('./fit_models/vgg16_60epochs.keras')
...
predictions = keras_tools.keras_predict(df = image_info, x_col='filepath', 
                                        model = keras_model, target_size=(224,224),
                                        preprocess_func=keras_tools.scale_images_0_1)

image_info.loc[:,class_categories.class_description] = predictions
